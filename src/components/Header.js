  ...
  render() {
    return (
      <header>
        <ul
          id="slide-out"
          class="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default"
            ...
            <ul class="collapsible collapsible-accordion">
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li>
                      <a href="product-page.html" class="waves-effect">
                        Product Page V.2
                      </a>
                    </li>
                    <li>
                      <a href="product-page-4.html" class="waves-effect">
                        Product Page V.3
                      </a>
                    </li>
                  </ul>
              ...
              <li class="active">
                ...
                <div class="collapsible-body">
                  <ul>
                    <li>
                      <a href="cart.html" class="waves-effect">
                    ...
                    <li>
                      <a href="contact-2.html" class="waves-effect">
                    ...
                    <li>
                      <a href="terms.html" class="waves-effect">
              ...
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    <li>
                      <a href="home-page.html" class="waves-effect">
                        Ecommerce homepage default
                      </a>
                    </li>
                    <li>
                      <a href="home-page-2.html" class="waves-effect">
                        Ecommerce homepage full width
                      </a>
                    </li>
                    <li>
                      <a href="home-page-3-carousel.html" class="waves-effect">
                    ...
                    <li>
                      <a href="home-page-4.html" class="waves-effect">
              ...
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    <li>
                      <a href="post.html" class="waves-effect">
                        Page with column on the right
                      </a>
                    </li>
                    <li>
                      <a href="blog-post-left-column.html" class="waves-effect">
                        Page with newsletter on the left
                      </a>
                    </li>
                    <li>
                      <a href="blog-post.html" class="waves-effect">
                        Page with newsletter on the right
                      </a>
                    </li>
                    <li>
                      <a href="blog-post-full-width.html" class="waves-effect">
              ...
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li>
                      <a href="category-right-column.html" class="waves-effect">
